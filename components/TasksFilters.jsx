      ...
      <div>
        ...
        <div className="flex flex-col items-start">
          <div className="flex justify-center items-center gap-3 py-2">
            ...
            <h3 className="font-extrabold text-lg text-[#717082b4]">Home</h3>
          </div>
          <div className="flex justify-center items-center gap-3 py-2">
            <span className="w-4 h-4 rounded-full bg-[#3fd4f4]"></span>
            <h3 className="font-extrabold text-lg text-[#717082b4]">Work</h3>
          </div>
          <div className="flex justify-center items-center gap-3 py-2">
            <span className="w-4 h-4 rounded-full bg-[#fac608]"></span>
            <h3 className="font-extrabold text-lg text-[#717082b4]">Grocery</h3>
          </div>
        </div>
      </div>
    </div>
